...
from data_io.torch_io.iam_paragraphs import IAMParagraphs
from data_io.torch_io.iam_synthetic_paragraphs import IAMSyntheticParagraphs


class IAMOriginalAndSyntheticParagraphs(DataModuleBase):
...
if __name__ == "__main__":
    torch_io.load_and_print_info(IAMOriginalAndSyntheticParagraphs)
