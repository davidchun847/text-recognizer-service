...
class CTCLitModel(BaseLitModel):  # pylint: disable=too-many-ancestors
    ...
    def __init__(self, model, args: argparse.Namespace = None):
        ...
        start_index = inverse_mapping[
            str_utils.get_special_char(str_utils.ESpecialChar.start)
        ]
        self.blank_index = inverse_mapping[
            str_utils.get_special_char(str_utils.ESpecialChar.blank)
        ]
        end_index = inverse_mapping[
            str_utils.get_special_char(str_utils.ESpecialChar.end)
        ]
        self.padding_index = inverse_mapping[
            str_utils.get_special_char(str_utils.ESpecialChar.pad)
        ]
    ...
    def training_step(self, batch, batch_idx):  # pylint: disable=unused-argument
        ...
        target_lengths = torch_utils.first_element(y, self.padding_index).type_as(y)
    ...
    def validation_step(self, batch, batch_idx):  # pylint: disable=unused-argument
        ...
        target_lengths = torch_utils.first_element(y, self.padding_index).type_as(
            y
