...
from services.pl_trainer_set_builder import Pl_Trainer_Set_Builder
...
class Text_Recognizer_Trainer_Set_Builder(Pl_Trainer_Set_Builder):
    ...
    def _add_callbacks(cls, dir_workspace, trainer_set, args):
        ...
        trainer_set.add_callback(
            ...
            pl_callbacks.create_earlystop_callback(mode=args.early_stop_mode, patience=args.early_stop_patience),
        )
